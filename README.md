...
Each task showcases a different front-end concept — from layout design to interactivity. You can open the index.html files in your browser to preview them.

📚 Learning Highlights

Mastered HTML semantic structure
